        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full font-display font-bold py-2.5 px-4 rounded-lg transition-all disabled:opacity-50 uppercase text-sm ${
                isLogin 
                  ? 'bg-white hover:bg-slate-100 text-black' 
                  : 'bg-[#FFC800] hover:bg-[#FFD700] text-black shadow-[0_0_20px_rgba(255,200,0,0.2)] hover:shadow-[0_0_30px_rgba(255,200,0,0.4)]'
              }`}
            >
          ...
          <div className="flex items-center gap-3 my-4">
            ...
            <span className="text-slate-600 text-[10px] uppercase tracking-wider">o continúa con</span>
            <div className="flex-1 h-px bg-[#1e2330]" />
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-[#1a1d26] hover:bg-[#252830] border border-[#2a2d36] text-slate-300 py-2.5 px-4 rounded-lg transition-all hover:border-[#FFC800]/30 text-sm"
          >
