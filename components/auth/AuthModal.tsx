      ...
      <div className="relative w-full max-w-md bg-[#0d1019] border border-[#1e2330] rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div className="p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-[#1a1d26] hover:bg-[#252830] border border-[#2a2d36] text-slate-300 py-3 px-4 rounded-lg transition-all hover:border-[#FFC800]/30 mb-4"
          >
          ...
          {/* Terms checkbox */}
          <label className="flex items-start gap-3 text-xs text-slate-500 mb-6 cursor-pointer group">
            <input
              type="checkbox"
              checked={agreed}
              onChange={(e) => setAgreed(e.target.checked)}
              className="mt-0.5 w-4 h-4 rounded border-[#2a2d36] bg-[#1a1d26] text-[#FFC800] focus:ring-[#FFC800] focus:ring-offset-0 accent-[#FFC800]"
            />
            <span className="group-hover:text-slate-400 transition-colors">
              Al acceder al sitio, confirmo que tengo al menos 18 años y acepto los{' '}
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-slate-600 text-xs uppercase tracking-wider">o</span>
            <div className="flex-1 h-px bg-[#1e2330]" />
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full bg-[#1a1d26] border border-[#2a2d36] text-white px-4 py-3 rounded-lg focus:outline-none focus:border-[#FFC800] transition-colors placeholder-slate-600"
            ...
            <div className="mb-5">
              <label className="block text-slate-400 text-xs font-medium mb-2 uppercase tracking-wider">Contraseña</label>
              <input
                type="password"
                value={password}
