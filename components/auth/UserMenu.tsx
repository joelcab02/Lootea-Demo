  ...
  return (
    <>
      <div className="flex items-center gap-2">
        <button
          onClick={openLogin}
          className="px-3 md:px-4 py-1.5 md:py-2 text-slate-400 hover:text-white transition-colors text-xs md:text-sm font-bold uppercase tracking-tight"
        >
          Entrar
        </button>
        <button
          onClick={openRegister}
          className="px-3 md:px-4 py-1.5 md:py-2 bg-[#FFC800] hover:bg-[#FFD700] text-black rounded-md md:rounded-lg transition-all text-xs md:text-sm font-black uppercase tracking-tight shadow-[0_0_10px_rgba(255,200,0,0.2)] hover:shadow-[0_0_20px_rgba(255,200,0,0.4)]"
        >
          Registro
        </button>
      </div>
