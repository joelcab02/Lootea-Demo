...
export default function CaseContentGrid() {
  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto mt-4 md:mt-8 p-4 md:p-6 bg-[#0d1019]">
      <div className="flex items-center justify-between mb-6 md:mb-8 border-b border-[#1e2330] pb-4">
        <div>
            ...
            return (
              <div key={item.id} className="group relative bg-gradient-to-b from-[#13151b] to-[#0a0c10] border border-[#1e2330] hover:border-[#FFC800] transition-all duration-200 rounded-xl overflow-hidden flex flex-col">
                ...
                <div className="p-2 bg-[#0a0c10] border-t border-[#1e2330] mt-auto">
                    {/* Price Button */}
                    <div className="bg-[#FFC800] hover:bg-[#EAB308] cursor-pointer text-black font-black text-xs md:text-sm text-center py-2 rounded uppercase tracking-wide mb-2 shadow-sm transition-colors">
