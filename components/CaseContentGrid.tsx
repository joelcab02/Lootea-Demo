              ...
              <div key={item.id} className="group relative bg-gradient-to-b from-[#13151b] to-[#0a0c10] border border-[#1e2330] hover:border-[#FFC800] transition-all duration-200 rounded-xl overflow-hidden flex flex-col">
                ...
                <div className="p-3 md:p-4 flex flex-col items-center flex-1">
                    ...
                    <div className="text-center w-full mb-2">
                        <div className={`text-[10px] md:text-xs font-black leading-tight text-white group-hover:text-[#FFC800] transition-colors tracking-wide uppercase h-8 flex items-center justify-center`}>
                            {item.name}
                        </div>
                    </div>

                    {/* Image Area */}
                    <div className="relative w-16 h-16 md:w-24 md:h-24 my-2 transition-transform duration-300 group-hover:scale-110 flex items-center justify-center">
                        ...
                        {isEmoji ? (
                            <span className="text-5xl md:text-6xl filter drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)] select-none">
                                {item.image}
                            </span>
                        ) : (
                            <img 
                ...
                <div className="p-2 bg-[#0a0c10] border-t border-[#1e2330] mt-auto">
                    {/* Price Button */}
                    <div className="bg-[#FFC800] hover:bg-[#EAB308] cursor-pointer text-black font-black text-xs md:text-sm text-center py-1.5 md:py-2 rounded uppercase tracking-wide mb-2 shadow-sm transition-colors">
