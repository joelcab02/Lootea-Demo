...
const Spinner: React.FC<SpinnerProps> = ({ isSpinning, onSpinStart, onSpinEnd }) => {
  ...
  return (
    <div className="relative w-full h-[220px] sm:h-[260px] overflow-hidden bg-[#0a0c10] border-y-2 border-[#1e2330] flex items-center shadow-inner transition-all duration-300">
        ...
        <div className="absolute left-1/2 top-0 transform -translate-x-1/2 -translate-y-1 text-[#FFC800] z-30 filter drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
             <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor"><path d="M12 16L4 4h16z"/></svg>
        </div>
        ...
        <div className="absolute left-1/2 bottom-0 transform -translate-x-1/2 translate-y-1 text-[#FFC800] z-30 filter drop-shadow-[0_-2px_4px_rgba(0,0,0,0.5)]">
             <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor"><path d="M12 8l8 12H4z"/></svg>
        </div>
