    ...
    <div className="flex h-screen bg-[#0d1019] text-white font-sans overflow-hidden selection:bg-[#FFC800] selection:text-black">
      ...
      <div className="flex-1 flex flex-col relative overflow-y-auto custom-scrollbar">
        ...
        <div className="flex flex-col items-center pt-6 md:pt-10 pb-8 md:pb-12 relative">
            ...
            {/* SPINNER COMPONENT */}
            <div className="w-full max-w-[1200px] px-0 sm:px-4 z-10 mb-6 md:mb-10">
                <Spinner 
            ...
            <div className="z-10 flex flex-col md:flex-row items-center gap-3 md:gap-4 w-full max-w-[1100px] px-4">
                ...
                <button 
                    ...
                    disabled={isSpinning}
                    className="
                        w-full md:w-auto min-w-[280px] relative px-8 py-3.5 bg-[#FFC800] hover:bg-[#EAB308] active:scale-[0.98] transition-all
                ...
                <div className="flex gap-2 w-full md:w-auto">
                     ...
                     <button className="w-12 h-12 rounded-lg bg-[#161922] border border-[#2a3040] flex items-center justify-center text-slate-400 hover:text-white hover:bg-[#1e2330] transition-colors shrink-0">
                        <Icons.Lightning />
                     </button>
                </div>
            </div>
      ...
      {showModal && winner && (
         <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-200">
            <div className="bg-[#161922] border border-[#FFC800]/50 rounded-xl p-8 max-w-sm w-full text-center relative shadow-2xl animate-in zoom-in-95 duration-300">
                ...
                <div className="relative w-56 h-56 mx-auto mb-8 group perspective-1000 flex items-center justify-center">
                    <div className={`absolute inset-0 rounded-full blur-[60px] opacity-20 ${RARITY_COLORS[winner.rarity].replace('text-', 'bg-')}`}></div>
                    <span className="text-9xl filter drop-shadow-2xl animate-bounce select-none relative z-10">
                        {winner.image}
                    </span>
                </div>
