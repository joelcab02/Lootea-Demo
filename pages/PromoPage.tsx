            ...
            {registerSuccess ? (
              ...
              <>
                ...
                <div className="text-center mb-6">
                  ...
                  {/* Value Card - Only show if prize is NOT a bonus (avoid redundancy) and there's value to show */}
                  {(() => {
                    ...
                    // Don't show card if prize is already a bonus (redundant)
                    if (isBonusPrize && !hasBonus) return null;
                    // Don't show if nothing to display
                    if (!hasPrice && !hasBonus) return null;
                    
                    return (
                      <div className="inline-block px-5 py-3 rounded-xl bg-gradient-to-b from-[#F7C948]/15 to-[#F7C948]/5 border border-[#F7C948]/30">
                        ...
                        {hasBonus && (
                          <p className={`text-emerald-400 text-sm font-medium ${!isBonusPrize && hasPrice ? 'mt-0.5' : ''}`}>
                ...
                <form onSubmit={handleRegister} className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-[#1a1d26] border border-[#2a2d36] text-white text-sm pl-11 pr-4 py-3 rounded-lg focus:outline-none focus:border-[#F7C948] transition-colors placeholder-slate-500 disabled:opacity-50"
                    />
                  </div>
                  ...
                  {/* Error message */}
                  {registerError && (
                    <div className="p-2.5 bg-red-500/10 border border-red-500/30 rounded-lg text-red-400 text-center text-xs">
                      {registerError}
                    </div>
                  )}
                  ...
                  <button 
                    type="submit"
                    disabled={isRegistering}
                    className="w-full py-3.5 bg-gradient-to-b from-[#FFD966] to-[#F7C948] hover:from-[#FFE082] hover:to-[#FFD966] text-black font-display font-bold text-base uppercase tracking-tight rounded-lg transition-all shadow-[0_4px_20px_rgba(247,201,72,0.3)] hover:shadow-[0_6px_25px_rgba(247,201,72,0.4)] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isRegistering ? (
                      <>
                  ...
                  <button 
                    ...
                    disabled={isRegistering}
                    className="w-full py-3 bg-white hover:bg-gray-100 text-gray-800 font-medium text-sm rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                  >
