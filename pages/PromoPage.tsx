...
const PromoPage: React.FC = () => {
  ...
  const [allResults, setAllResults] = useState<{ item: LootItem; display: string }[]>([]); // Track all 3 prizes
  ...
  useEffect(() => {
    if (showRegisterModal && timeLeft > 0) {
      const timer = setInterval(() => {
        setTimeLeft(prev => Math.max(0, prev - 1));
      }, 1000);
      return () => clearInterval(timer);
    }
  }, [showRegisterModal, timeLeft]);
  ...
  const handleSpinComplete = () => {
    ...
    if (currentWinner && promoConfig) {
      ...
      const newResult = { item: currentWinner, display: displayText };
      setLastResult(newResult);
      setAllResults(prev => [...prev, newResult]); // Track all prizes
  ...
  if (showRegisterModal) {
    return (
      <div className="min-h-screen bg-[#111111] flex flex-col relative overflow-hidden">
          ...
          {[...Array(50)].map((_, i) => (
            <div
              ...
              style={{
                ...
                top: `-10px`,
                backgroundColor: ['#F7C948', '#FFD966', '#FF6B6B', '#4ECDC4', '#45B7D1'][Math.floor(Math.random() * 5)],
        ...
        {/* Header */}
        <header className="py-4 px-4 border-b border-[#1e2330] relative z-10">
          ...
          <div className="w-full max-w-md">
            {registerSuccess ? (
              ...
              <div className="text-center py-8">
                <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-[#F7C948]/20 flex items-center justify-center text-[#F7C948] animate-bounce">
                  <Icons.Check />
                </div>
              ...
              <>
                ...
                <div className="text-center mb-5">
                  ...
                  <div className="inline-block px-8 py-4 rounded-2xl bg-gradient-to-r from-[#F7C948]/5 via-[#F7C948]/20 to-[#F7C948]/5 border border-[#F7C948]/40 mb-4 animate-shimmer bg-[length:200%_100%]">
                    <span className="font-display font-black text-5xl text-[#F7C948] drop-shadow-[0_0_20px_rgba(247,201,72,0.5)]">
                ...
                {allResults.length > 0 && (
                  <div className="bg-[#1a1d26]/50 rounded-xl p-3 mb-4 border border-[#2a2d36]">
                    <p className="text-slate-500 text-[10px] uppercase tracking-wider mb-2 text-center">Tus premios</p>
                    <div className="flex justify-center gap-2">
                      {allResults.map((result, idx) => (
                        <div key={idx} className="flex items-center gap-1.5 px-2.5 py-1.5 bg-[#0d1019] rounded-lg">
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3.5 px-4 rounded-xl transition-all text-sm font-display uppercase bg-white hover:bg-gray-100 disabled:opacity-50 mb-3"
                >
                ...
                <div className="flex items-center gap-3 my-4">
                  ...
                  <span className="text-slate-600 text-[10px] uppercase tracking-wider">o con email</span>
                  <div className="flex-1 h-px bg-[#2a2d36]"></div>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-3">
                  ...
                  {/* Submit Button - Pulsing Gold */}
                  <button 
                    type="submit"
                    disabled={isRegistering}
                    className="w-full py-3.5 bg-gradient-to-b from-[#FFD966] to-[#F7C948] hover:from-[#FFE082] hover:to-[#FFD966] text-black font-display font-bold text-sm uppercase tracking-tight rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 animate-pulse-gold"
                  >
                    {isRegistering ? (
                      <>
                      ...
                      `RECLAMAR MIS $${accumulatedBalance.toLocaleString()}`
                    )}
                  </button>
                </form>
        ...
        {/* Footer */}
        <footer className="py-4 px-4 border-t border-[#1e2330] text-center relative z-10">
          <p className="text-slate-600 text-[10px]">
            Solo mayores de 18. Juega responsablemente.
          </p>
        </footer>
        ...
        <style>{`
          ...
          @keyframes pulse-gold {
            0%, 100% { box-shadow: 0 4px 20px rgba(247,201,72,0.4); }
            50% { box-shadow: 0 4px 30px rgba(247,201,72,0.7); }
          }
          .animate-pulse-gold {
